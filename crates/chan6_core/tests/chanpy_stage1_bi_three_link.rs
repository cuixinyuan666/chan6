...
fn chanpy_stage1_bi_three_link_gold_matches_main_pipeline() {
    let csv = include_str!("../../../fixtures/chanpy_stage1/input/stage1_bi_three_link_candidate.csv");
    let gold_text = include_str!("../../../fixtures/chanpy_stage1/gold/stage1_bi_three_link_candidate_chanpy_gold.json");
